...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-12-10 13:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/113eaefa-1060-4e0e-8b26-495cbdaaf3b8.git
$ cd 113eaefa-1060-4e0e-8b26-495cbdaaf3b8
```
